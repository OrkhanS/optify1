...
class newActivityPersonalPage extends State<newActivityPersonal> {
  ...
  TimeOfDay _timeStart,
      _timeEnd; //After we get time, add it into FROM and UNTIL section below, no need to ask it again below
        ...
        children: <Widget>[
              ...
              children: <Widget>[
                Container(
                  child: DropdownButton<String>(
                    ...
                    items: <String>['Montly', 'Weekly', 'Daily']
                        .map((String value) {
          ...
          Container(
              ...
              child: FloatingActionButton(
                ...
                onPressed: () {
                  String url = Api.newActivityPersonal +
                      widget.schedule_id.toString()+"/activities/";
                  http
                      .post(url,
                          headers: {
