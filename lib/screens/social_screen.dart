    ...
    return Row(
      children: <Widget>[
        ...
        Expanded(
          flex: 3,
          child: Card(
            child: widget.contacts[widget.i]["requester"]["id"].toString() ==
                ...
                Padding(
                    ...
                    child: widget.contacts[widget.i]["state"].toString() == "req" // If another person hasn't accepted my request yet.
                        ...
                        /// Start My Contact (which I sent request)
