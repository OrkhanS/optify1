...
import 'package:optifyapp/local_notications_helper.dart';
import 'package:optifyapp/screens/orders_screen.dart';
        ...
        child: ListView(
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: () => showOngoingNotification(notifications, title: 'Briddgy', body: 'You have a new message!'),
            ),
            // RaisedButton(
